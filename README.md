...
- normalized performance chart on the compare page
- portfolio page with weighted portfolio analytics
...
- typed portfolio client for `/api/v1/portfolio/analytics`
...
`PortfolioPage` posts weighted asset allocations to the backend and renders a portfolio summary plus weighted portfolio performance chart.
